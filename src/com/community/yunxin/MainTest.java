...
*/  
    ...
    private static String APPKEY = "6810f61a8a485cfd7a776e76309e62e4";
    private static String SECRET = "92922ea6767e";  //AppSecret
    ...
    public static String createUser(String accid, String name, String token,String icon) throws IOException {
        ...
        params.add(new BasicNameValuePair("icon", "http://47.94.227.97:8080"+icon));
